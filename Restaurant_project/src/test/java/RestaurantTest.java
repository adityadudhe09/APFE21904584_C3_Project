...
class RestaurantTest {
    ...
    public void is_restaurant_open_should_return_true_if_time_is_between_opening_and_closing_time(){
        ...
        restaurantName();
        restaurant.setOpeningTime(LocalTime.now().minusHours(1));
    ...
    public void is_restaurant_open_should_return_false_if_time_is_outside_opening_and_closing_time(){
        //WRITE UNIT TEST CASE HERE
        restaurantName();
//        restaurant.setOpeningTime(LocalTime.now().plusHours(1));

        /* We can use below method as well which passed the test case*/
//       restaurant.setClosingTime(LocalTime.now().minusHours(1));
